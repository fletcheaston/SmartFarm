/* -------------------- Controller Firmware Version 0.2 ---------------------
   This program is the controller firmware for smartfarm DAQ board V6.0
...
low_fuses=0xE2
  ...
  19 ------ A6          -- XBee RSSI            -- Input
  22 ------ A7          -- XBee sleep indictor  -- Input
  ...
  31 ------ PD1/TX/D1   -- Other sensor power   -- Output
  32 ------ PD2/INT0/D2 -- Wireless pro. detect -- Input
  1 ------- PD3/INT1/D3 -- Serial sensor power  -- Output
  2 ------- PD4/D4      -- XBee RTS             -- Output
  9 ------- PD5/D5      -- XBee Association     -- Input
  10 ------ PD6/D6      -- XBee CTS             -- Input
...
const byte otherPower = 1; //Other sensor power pin
const byte proSigIn = 2; // Wireless programming signal detection 
const byte serialPower = 3; // Serial sensor power
...
int proWaitTime = 900; //Wireless programming waiting time(in seconds)
